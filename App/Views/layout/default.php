...
<body>
    ...
    <div style="overflow-x: hidden;" class="container-fluid d-flex flew-wrap align-items-stresh p-0 m-0 position relative">
        <div style="background-color:#12141C" class=" <?= ($_GET['url'] == 'tuto') ? "d-none " : "d-none d-md-block " ?> left col-md-3 position-fixed ">
