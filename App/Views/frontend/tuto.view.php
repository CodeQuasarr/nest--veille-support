<div style="background-color:#12141C" class="left col-md-3 position-fixed">
    ...
    <div class="content col-12 p-5">
        ...
        <div class="content col-12">
            ...
            <div class="col-md-10">
                ...
                <div class="col-12">
                    <img class="w-100" src="web/projet/projet.png" alt="">
                </div>
                ...
                <div class="col-12">
                    <img class="w-100" src="web/projet/terminal.png" alt="">
                </div>
                <p class="paragraph ms-4">
                    Il vous sera demander de choisir votre gestionnaire de
                ...
                <h4 class="title py-4 ms-4"> <span class="next-text-color"># </span>Lancement du serveur de
                    développement</h4>
                <div class="col-12">
                    <img class="w-100" src="web/projet/ide.png" alt="">
                </div>
                <p class="paragraph ms-4">
                ...
                <div class="col-12">
                    <img class="w-100" src="web/projet/HELLOwORLD.PNG" alt="">
                </div>
                <p class="paragraph ms-4">
                ...
                <div class="col-12">
                    <img class="w-100" src="web/projet/files.PNG" alt="">
                </div>
                ...
                <p id="module" class="paragraph ms-4">
                    ...
                    <br>
                    - On importe un controle ( <span class="text-danger">AppController</span> ) depuis un fichier local. Ce
                    ...
                    <br>
                    - On importe un service <span class="text-danger">AppService</span> ) qui est charger de fournir des
                    fonctionnalités à votre controlleur
                </p>
                <div class="col-12">
                    <img class="w-100" src="web/projet/sup1.PNG" alt="">
                </div>
                <p class="paragraph ms-4">
                    <br> Nous n'avons pas vraiment besoin de certain fichier comme le <span class="text-danger">"AppController.ts", "AppService.ts" </span> notre app Controller et
                    de ces
                    services dans le cas de ce projet.
                    <br> Je vous invite à supprimer ces fichier ainsi que que dans le <span class="text-danger">Appmodule.ts</span>
                </p>
                <p class="paragraph ms-4">
                    Maintenant que nous avons un module vide, nous allons géneré nos propre modele grace à la
                    commande:
                <div class="alert alert-secondary" role="alert">
                ...
                <p class="paragraph ms-4">
                    vous remarquerez que cela vous crée un module <span class="text-danger">dawin.module.ts</span> et met a jour automatiquement notre <span class="text-danger">app.module.ts</span>
                <div class="alert alert-secondary" role="alert">
                    $ nest g module dawins
                </div>
                </p>
                <p class="paragraph ms-4">
                    Nous allons creer les composant qui permetrons a notre application de fonctionner
                <div class="alert alert-secondary" role="alert">
                    $ nest g co dawins <br>
                    $ nest g s dawins
                </div>
                ...
                <div class="col-12">
                    <img class="w-100" src="web/projet/dawin.PNG" alt="">
                </div>
                <p class="paragraph ms-4">
                    vous remarquerez que cela vous crée un repertoire dans lequel se trouve tous les
                    fonctionnalités lier au nom de ce repectoire comme expliquer <a href="#module">ici</a>
                    <br>
                    testons Maintenant nos fonctionnalités fonctionne
                </p>
                <p class="paragraph ms-4">
                ...
                <p class="paragraph ms-4">
                    si nous retournons dans notre navigateur avec <span class="text-danger">npm run start</span> vous verrez
                </p>
                <div class="col-12">
                    <img class="w-100" src="web/projet/dawinShow.PNG" alt="">
                </div>

                <p class="paragraph ms-4">
                    Maintenant que tout fonctionne convenablement, nous allons ajouter un <span class="text-danger">swagger</span> dans notre fichier <span class="text-danger">main.ts</span>.
                    <br>
                ...
                <p class="paragraph ms-4">
                    Je vous invite à initialisez <span class="text-danger">Swagger</span> à l'aide de la <span class="text-danger">SwaggerModuleclasse</span> dans le fichier <span class="text-danger">main.ts</span> de la sorte
                </p>
                <div class="col-12">
                    <img class="w-100" src="web/projet/crud.PNG" alt="">
                </div>
                <p class="paragraph ms-4">
                    Ouvrez votre navigateur et accédez à <a href="http://localhost:3000/">http://localhost:3000/</a>. Vous devriez voir l'interface utilisateur Swagger.
                </p>
                <div class="col-12">
                    <img class="w-100" src="web/projet/sawager.PNG" alt="">
                </div>

                <p class="paragraph ms-4">
                    Maintenant nous allons faire notre configuration pour la base de donnée.
                    <br> Pour ce tuto j'utiliserai Mysql comme base de donnée.Vous pouvez absolument utiliser la base de donne=ée que vous souhaitez mais nous somme pour la simpliciter, je vais utilser MySQL
                </p>
                <p class="paragraph ms-4">
                    Une fois de plus je vais vous montrer la <a href="https://docs.nestjs.com/techniques/database">documentation</a> afin que vous sachier comment initialiser votre base de donnée dans notre application NestJS
                </p>
                ...
                <p class="paragraph ms-4">
                    Je vous invite à initialisez la connection a la base de donnée fichier <span class="text-danger">app.module.ts</span> de la sorte
                </p>

                <div class="col-12">
                    <img class="w-100" src="web/projet/bd.PNG" alt="">
                </div>

                <p class="paragraph ms-4">
                    La prochaine chose à faire est de créer un fichier d'entité <span class="text-danger">dawin.entity.ts</span> dans notre répectoire dawins
                </p>

                <div class="col-12">
                    <img class="w-100" src="web/projet/crudapi.PNG" alt="">
                </div>
                <p class="paragraph ms-4">
                    <span class="text-danger">dawin.entity.ts</span> represnente la classe Dawin que nous avon créer dans notre base de donnée.
                    <br>
                    Maintenant, nous avont notre classe entité, lorsque vous executer votre application, il devra vous créer une nouvelle table dawin dans la base de donnée
                </p>
                <p class="paragraph ms-4">
                ...
                <p class="paragraph ms-4">
                    Mais nous allons decider d'utiliser plutot un autre library NestJS disponible sur <a href="https://github.com/nestjsx/crud/wiki/Controllers#description">GitHub</a>
                </p>
            </div>
        </div>
    </div>
