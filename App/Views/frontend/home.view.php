            ...
            <div class="content col-12 p-5">
                ...
                <div class="content col-12">
                    ...
                    <div style="min-height: 100;" class="py-5" id="install">
                        ...
                        <P class="paragraph">
                            Tout d'abord, vous aurez besoin du runtime node que vous pouvez telecharger <a class="fw-bold text-danger" href="https://nodejs.org/en/download/">ici</a>.
                            <br>
                        ...
                        <div class="col-md-10">
                            ...
                            <p class="paragraph ms-4">
                                ...
                                Ouvrez votre navigateur et accédez à <a class="fw-bold text-danger" href="http://localhost:3000/">http://localhost:3000/</a>.
                            </p>
                        </div>
                    </div>
                    ...
                    <div style="min-height: 100;" class="py-5" id="tuto">
                        <h1>#TUTO# </h1>
                        <p class="paragraph ms-4">
                            je vous invite à cloner mon mon repectoire <a class="fw-bold text-danger" href="https://github.com/Sanyaronke/veille_techno_nest_js">Git</a> et visiter <a class="fw-bold text-danger" href="https://api-support.herokuapp.com/">l'application</a>; ce mini projet vous permet de faire un API Rest avec NestJS
                            <br>
                            ou suivre Mon petit tuto <a class="fw-bold text-danger" href="tuto">ici</a>
                        </p>
                        <div class="col-12">
